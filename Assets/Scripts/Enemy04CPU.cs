...
public class Enemy04CPU : MonoBehaviour
{
    enum ActionStep
    {
        One, //移动到目标Y坐标
    ...
    void Bullet(float target_x)
    {
        ...
        bullet_left.DOLocalMove(target_pos, 9.0f).SetEase(Ease.Linear);
        ...
        bullet_right.DOLocalMove(target_pos, 9.0f).SetEase(Ease.Linear);
